...
class TestFutureHorizonLabeling:
    ...
    def test_no_incidents(self):
        ...
        _, y, _ = create_windows(df, W=5, H=3, stride=1)
    ...
    def test_single_future_incident(self):
        ...
        _, y, _ = create_windows(df, W=3, H=3, stride=1)
    ...
    def test_lookback_uses_correct_values(self):
        ...
        X, _, _ = create_windows(df, W=4, H=2, stride=1)
    ...
    def test_stride(self):
        ...
        X1, _, _ = create_windows(df, W=5, H=3, stride=1)
        X2, _, _ = create_windows(df, W=5, H=3, stride=3)
    ...
    def test_timestamps_align(self):
        ...
        _, _, ts = create_windows(df, W=3, H=3, stride=1)
    ...
    def test_too_short_raises(self):
        ...
        with pytest.raises(ValueError, match="shorter than W \\+ H"):
